...
class Person {
    ...
    setAge(newAge: number): void {
        if (newAge != null && newAge > 0) {
            ...
            console.warn('setAge(): impostato un valore non corretto: ' + newAge);
        }
    }
...
let person1: Person = new Person('Simone', 'Rossi', 'Student', 50, '13/04/1970', 'Rimini');
...
let person2: Person = new Person('Carlo', 'Bianchi', 'Student', 0, '21/06/1985', 'Riccione');
person2.setAge(35);
person2.setAge(-10);
...
class PersonWorker extends Person {
    ...
    constructor(
        ...
        console.log('=> PersonWorker.constructor(): ' + this.name + ' ' + this.surname);
    ...
    toString(): string {
        console.log('=> PersonWorker.toString(): ' + this.name + ' ' + this.surname);
        let result = super.toString();
        return result + ' lavora in ' + this.company;
    }
}

let worker1: PersonWorker = new PersonWorker('Franco', 'Neri', 'Worker',
                                              40, '21/06/1980', 'Cattolica', '01Sistemi');
